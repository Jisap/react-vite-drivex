  ...
  return (
    <>
      <div className="ctg-car-item relative rounded-4xl overflow-hidden group">
        ...
        <Link
          to="/cars"
          className="icon absolute bottom-10 right-10 text-white bg-primary w-12 h-12 centered-row justify-center rounded-full p-2 group-hover:rotate-45 transition-all duration-300"
        >
          <MoveRight />
        </Link>
      </div>
